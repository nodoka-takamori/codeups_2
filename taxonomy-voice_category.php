    ...
    <div class="page-voice__inner inner">
        ...
        <div class="voice-card__container voice-cards">
            ...
            $args = array(
                ...
                'orderby' => 'date',               // 日付順
                'order' => 'DESC',                 // 降順
                'tax_query' => $current_term_id ? array( // タクソノミーの絞り込みを設定
                    array(
                            ...
                            <div class="voice-card">
                                <div class="voice-card__head">
                                    ...
                                    <div class="voice-card__img">
                                        ...
                                        <?php else : ?>
                                            <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/common/noimage.jpg" alt="noimage" />
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="voice-card__body">
                                    <p class="voice-card__text">
                                        ...
                                        echo mb_strlen($content, 'UTF-8') > 100 ? mb_substr($content, 0, 100, 'UTF-8') . '...' : $content;
                                        ?>
                                    </p>
                                </div>
                            </div>
